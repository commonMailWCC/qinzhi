...
public class ShiroPrincipal implements Serializable {
     ...
     * @param user
     */
    public ShiroPrincipal(SysOperator user) {
        this.user = user;
    }
    ...
    public SysOperator getUser() {
        return user;
    }

    public void setUser(SysOperator user) {
        this.user = user;
    }

    public String getUsername() {
        return this.user.getOperatorLoginName();
    }

    public Long getId() {
        return this.user.getOperatorId();
    }
    ...
    public String toString() {
        return this.user.getOperatorName();
    }
}
