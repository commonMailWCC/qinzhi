...
public class FileUtils {
    ...
    public static String getContextRootPath(HttpServletRequest request) {
        ...
        contextPath += contextPath.endsWith(File.separator) ? "" : File.separator;
    ...
    public static String fileUpload(MultipartFile uploadFile, String configFileDirName, String configFileFixName, String fileUploadRootPath) {
        ...
        if (uploadFile != null && !uploadFile.isEmpty()) {
            ...
            if (!configFileDirName.endsWith(File.separator)) {
                configFileDirName = configFileDirName + File.separator;
            }
            ...
            //生成文件保存名称为
            String fileName = configFileDirName + File.separator + configFileFixName + "_" + FileUtils.getFileNameByDateTime() + subFix;//customer.getUsername() + "_" +
            //获取文件上传路径
